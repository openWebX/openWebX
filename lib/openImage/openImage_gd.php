...
// ########################################################################
class openImage_gd implements openImage_Interface {
	...
	private function imgResize($iWidth,$iHeight) {
		$image  = imagecreatetruecolor($iWidth,$iHeight);
		imagecopyresampled($image, $this->image['object'], 0, 0, 0, 0, $iWidth, $iHeight, $this->image['width'], $this->image['height']);
		$this->image['object'] = $image;
		$this->image['width']	= imagesx($this->image['object']);
		$this->image['height']	= imagesy($this->image['object']);
	}

	private function imgScale($iWidth,$iHeight) {
